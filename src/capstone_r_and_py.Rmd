...
#chi_square_value,p_value=calculate_bartlett_sphericity(eff)
#chi_square_value, p_value

#from factor_analyzer.factor_analyzer import calculate_kmo
#kmo_all,kmo_model=calculate_kmo(eff)
#kmo_model
...
eff_weights =  fa.get_factor_variance()[1]
np.sum(eff_weights)
...
## NOTE @abhi18av  possible correction
# Rows with attribute values having less than 3 non-NA's are removed(Removing all such hospitals)
...
#row_nan_counts = eff.isnull().sum(axis=1).to_list()

#row_nan_counts_boolean = []

#for a_count in row_nan_counts:
#    if a_count <= 3:
#        row_nan_counts_boolean.append(1)
#    else:
#        row_nan_counts_boolean.append(0)
      
#row_nan_counts_boolean

#eff['remove'] =  row_nan_counts_boolean
#eff
#eff.to_csv("eff_data_py.csv")
#print_ln()

#eff['remove'].sum() / eff['remove'].count()
#print_ln()

#eff.isnull().sum(axis=1)
#eff.isnull().sum(axis=1).to_list()
#eff.shape[1] - eff.count(axis=1)
#print_ln()

#eff.dropna(thresh= 15)
