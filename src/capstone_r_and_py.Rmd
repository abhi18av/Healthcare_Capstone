...
```
```{python}
read_meas_score =  rename_columns(read_meas_score)
read_meas_score
print_ln()
...
rf_predictions = model_rf1.predict(X_test)

rf_predictions
print_ln()

# Probabilities for each class
rf_probs = model_rf1.predict_proba(X_test)[:, 1]

from sklearn.metrics import roc_auc_score

# Training predictions (to demonstrate overfitting)
train_rf_predictions = model_rf1.predict(X_train)
train_rf_probs = model_rf1.predict_proba(X_train)[:, 1]
...
#rf_probs = model_rf1.predict_proba(y_test)[:, 1]
