...
def subset(dataframe, col_name, col_names_list):
    return dataframe.loc[expe_meas[col_name].isin(col_names_list)]
...
subset(expe_meas, 'Measure ID', expe_meas_list)
...
experience = negative_zscore(experience)
experience
print_ln()
